...
void AstralRaytracer::LuminanceThresholdPostProcessing::processImage(DrawingPanel &drawPanel,
...
const char *const AstralRaytracer::LuminanceThresholdPostProcessing::getFragmentShaderSrcCode() const
{
    return R"SHADER(		
			#version 330 core
			in vec2 textureUV;
