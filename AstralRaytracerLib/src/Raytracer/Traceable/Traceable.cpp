...
const glm::vec3 &Traceable::getPosition() const
{
    return m_transform.getPosition();
}

float32 Traceable::getRotation() const
{
    return m_transform.getRotation();
}

const glm::vec3 &Traceable::getScale() const
{
    return m_transform.getScale();
}

const glm::mat4 &Traceable::getTransformMatrix() const
{
    return m_transform.getMatrix();
}

Transform &Traceable::getTransform()
{
    return m_transform;
}

uint32 Traceable::getMaterialIndex() const
{
