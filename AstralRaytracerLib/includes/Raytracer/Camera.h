...
{
  public:
    Camera(float32 focalLength, float32 sensorHeight, float32 focusDistance, float32 apertureDiameter,
           float32 nearClip = 0.01f, float32 farClip = 100.0f);
    ...
    void setFarClipDistance(float32 farClip)
    {
        m_farClip = farClip;
    }
    ...
    void setNearClipDistance(float32 nearClip)
    {
        m_nearClip = nearClip;
    }
    ...
    void setSensorHeight(float32 sensorHeight)
    {
        m_sensorHeight = sensorHeight;
    }

    float32 getSensorHeight() const
    {
        return m_sensorHeight;
    }

    void setFocalLength(float32 focalLength)
    {
    ...
    void setAperture(float32 apertureSize)
    {
        m_apertureDiameter = apertureSize;
    }

    float32 getApertureDiameter() const
    {
        return m_apertureDiameter;
    }

    void setFocusDistance(float32 focusDistance)
    {
        m_focusDistance = focusDistance;
    }

    float32 getFocusDistance() const
    {
