...
namespace AstralRaytracer
{
	struct ColourData
	{
		...
		public:
			...
			ColourData(float32 r, float32 g, float32 b, float32 a) { m_colour= glm::vec4(r, g, b, a); }

			ColourData(const glm::vec4& normalized) { m_colour= normalized; }
			...
			void setColour_32_bit(const glm::vec4& colour) { m_colour= colour; }
			...
			[[nodiscard]]
			glm::u8vec4 getColour_8_BitClamped() const
			{
