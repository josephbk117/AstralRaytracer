...
template <ArithmeticType T, uint32 ComponentCount> class TextureData
{
  ...
  public:
    ...
    [[nodiscard]] const std::vector<T> &getTextureData() const noexcept;
    ...
    [[nodiscard]] inline constexpr uint32 getComponentCount() const noexcept;

    void setTexelColorAtPixelIndex(uint32 index, const glm::vec<ComponentCount, T, glm::defaultp> &color);

    void setTexelColor(uint32 x, uint32 y, const glm::vec<ComponentCount, T, glm::defaultp> &color);
    [[nodiscard]] glm::vec<ComponentCount, T, glm::defaultp> getTexelColor(int32 x, int32 y) const;
    [[nodiscard]] glm::vec<ComponentCount, T, glm::defaultp> getTexelColor(float32 u, float32 v,
